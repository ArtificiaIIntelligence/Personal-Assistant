...
witTest3=[
         {"outcomes": [{"_text": "What is the time?", "confidence": 0.735, "entities": {'agenda_entry': 'timeNow'}, "intent": "agenda"}]},
         {"outcomes": [{"_text": "What day in the week is today?", "confidence": 0.735, "entities": {'agenda_entry': 'dayInWeek', "datetime":[{"grain":"day","type":"value","value":timeFut,"values":[{"grain":"day","type":"value","value":timeFut}]}]}, "intent": "agenda"}]},
         {"outcomes": [{"_text": "What date is today", "confidence": 0.735, "entities": {'agenda_entry': 'date', "datetime":[{"grain":"day","type":"value","value":now,"values":[{"grain":"day","type":"value","value":now}]}]}, "intent": "agenda"}]},
